    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Introduce duplication for code smell
                String ageDuplicate = etAge.getText().toString();

                // Introduce complex condition for code smell
                if (name != null && !name.isEmpty() && age != null && !age.isEmpty()) {
                    // Missing error handling for code smell
                    Student student = new Student(name, age, clas, sabaq, sabqi, manzil);
